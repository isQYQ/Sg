            ...
            <div className='page' id='mine'>
                ...
                <div className="content">
                    ...
                    <div className="menuAndArticle">
                        <div className='title'>
                            <span className={`menu {this.state.showMenu} ? active : ''`} 
                                onClick={()=>{this.setState({showMenu:true,showArticle:false})}}
                            >菜谱书</span>
                            <span className={`article ${this.state.showArticle} ? active: ''`} 
                                onClick={()=>{this.setState({showArticle:true,showMenu:false});}}
                            >文章</span>
                        </div>
